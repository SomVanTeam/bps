...
var newerURL = gmcurrentURLdecl.replace('https://linkvertise.com/376138/arceus-x-neo-key-system-1?o=sharing', 'https://lootdest.com/s?qljL');
var pageTitle = document.title;
var arceusapi = "https://spdmteam.com/api/keysystem?step=";
var arceusapisuffix = "&advertiser=linkvertise&OS=ios";
if (gmcurrentURLdecl.includes("https://linkvertise.com/376138/arceus-x-neo-key-system-1?o=sharing")) {
...
} else if (gmcurrentURLdecl.includes("https://spdmteam.com/key-system-2?hwid=")) {
...
} else if (gmcurrentURLdecl.includes("https://spdmteam.com/key-system-3?hwid=")) {
...
} else if (gmcurrentURLdecl.includes("/key-system-getkey")) {
